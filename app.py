...
app_ui = ui.page_navbar(
    ...
    ui.nav(ui.a("GitHub", href="https://github.com/s566248/cintel-02-app")),
    ui.nav(ui.a("App", href="https://s566248.github.io/cintel-02-app/")),
...
def server(input, output, session):
    ...
    def welcome_output():
        ...
        welcome_string = f'Hello {user}, welcome to my app!';
